...
Added a new class in the Models folder which is named as BrightLamp.cs and then, added a Primary key "Id" and properties like type, Price, Manufacturing Time and Material used.
